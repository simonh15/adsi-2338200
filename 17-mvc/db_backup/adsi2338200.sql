...
--
-- Servidor: localhost
-- Tiempo de generación: 02-11-2022 a las 13:49:45
...
CREATE TABLE `users` (
  ...
  `email` varchar(32) NOT NULL,
  `photo` varchar(32) NOT NULL DEFAULT 'public/imgs/nophoto.png',
...
INSERT INTO `users` (`id`, `fullname`, `email`, `photo`, `role`) VALUES
(1, 'Jeremias Springfield', 'jeremias@gmail.com', 'public/imgs/1667393262.jpg', 'Admin'),
(2, 'Donald Trumpx', 'donald@gmail.com', 'public/imgs/1667393272.jpg', 'Customer'),
(3, 'Pibe Valderrama', 'pibe@gmail.com', 'public/imgs/1667393247.jpg', 'Customer'),
(4, 'Clementina Valencia', 'clemen@gmail.com', 'public/imgs/1667393287.jpg', 'Customer'),
(5, 'Mario ', 'mario@gmail.com', 'public/imgs/1667392813.jpg', 'Customer'),
(6, 'Rihana', 'rihana@gmail.com', 'public/imgs/1667393320.jpg', 'Customer');
